...
const speculators = [
  { rank: 1, init: 'SC', bg: 'hsla(217,91%,60%,.15)', color: 'var(--blue-l)', name: 'Shadowcaller', addr: '0x3e…9a2b', tier: 'Legend', tierColor: 'var(--legend)', bets: 142, acc: '89%', xp: 4200, xpPct: 84, xpColor: 'var(--legend)', bestBet: '4.2x · 840 MNT' },
  { rank: 2, init: 'OO', bg: 'hsla(38,92%,50%,.15)', color: 'var(--amber)', name: 'OddsOracle', addr: '0x7f…2b4c', tier: 'Diamond', tierColor: 'var(--diamond)', bets: 98, acc: '81%', xp: 3710, xpPct: 72, xpColor: 'var(--diamond)', bestBet: '3.8x · 570 MNT' },
  { rank: 3, init: 'CS', bg: 'hsla(142,70%,50%,.15)', color: 'var(--green)', name: 'CryptoSeer', addr: '0x1c…4d2e', tier: 'Gold', tierColor: 'var(--gold)', bets: 77, acc: '76%', xp: 2980, xpPct: 58, xpColor: 'var(--gold)', bestBet: '2.9x · 420 MNT' },
  { rank: 4, init: 'PE', bg: 'hsla(280,70%,60%,.15)', color: '#c084fc', name: 'ProbEdge', addr: '0x6b…9e3f', tier: 'Silver', tierColor: 'var(--silver)', bets: 63, acc: '71%', xp: 2140, xpPct: 42, xpColor: 'var(--silver)', bestBet: '2.1x · 290 MNT' },
  { rank: 5, init: 'SN', bg: 'hsla(0,70%,60%,.15)', color: 'var(--red)', name: 'SignalNoise', addr: '0x4a…7f1b', tier: 'Bronze', tierColor: 'var(--bronze)', bets: 54, acc: '68%', xp: 1820, xpPct: 35, xpColor: 'var(--bronze)', bestBet: '1.8x · 180 MNT' },
];
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 2rem 4rem', display: 'grid', gridTemplateColumns: '1fr 280px', gap: '1.5rem', alignItems: 'start' }}>
          ...
          <div style={{ background: 'hsla(38,92%,50%,.05)', border: '1px solid hsla(38,92%,50%,.2)', borderRadius: 12, padding: '1rem 1.25rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '1rem' }}>
              ...
              <div style={{ textAlign: 'right', flexShrink: 0 }}>
                ...
                <div style={{ fontSize: 11, color: 'var(--green)' }}>+840 MNT</div>
                <div style={{ fontSize: 10, color: 'var(--muted)' }}>200 MNT wagered</div>
              </div>
            </div>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: 14, padding: '1.25rem' }}>
            ...
            <div style={{ fontSize: 11, color: 'var(--text2)', marginBottom: '.85rem' }}>Top 10 agents and speculators receive bonus MNT rewards.</div>
